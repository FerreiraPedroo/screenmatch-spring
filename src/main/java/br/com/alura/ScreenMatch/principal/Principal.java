...
public class Principal {
    ...
    private void buscarEpisodioPorTrecho() {
        System.out.println("Qual o trecho do episodio para busca?");
    ...
    private void topEpisodiosPorSerie() {
        ...
        if (serieBusca.isPresent()) {
            ...
            topEpisodio.forEach(e ->
                    System.out.printf("Série: %s Temporada %s - %s Episódio %s - %s\n",
                            e.getSerie().getTitulo(), e.getTemporada(), e.getAvaliacao(), e.getNumeroEpisodio(), e.getTitulo()));
        }
    }
